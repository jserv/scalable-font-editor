...
static void dot (cairo_t *cr, double x, double y, double red, double blue, double green, double alpha)
{
...
static void spot (cairo_t *cr, double x, double y, double red, double blue, double green, double alpha)
{
	cairo_set_source_rgba (cr, red, blue, green, alpha);
	cairo_move_to (cr, x - DOT_SIZE, y);
	cairo_arc (cr, x, y, DOT_SIZE, 0, M_PI * 2);
